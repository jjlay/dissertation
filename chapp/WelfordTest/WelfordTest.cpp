...
int main(int argc, char* argv[]) {
	...
	long double count = 0.0, mean = 0.0, M2 = 0.0, x = 0.0;
	int samples = 1000000;

	auto storage = new long double[samples];
	...
	long double randMean = 2.0, randStdDev = 3.0;
	std::default_random_engine generator;
	std::normal_distribution<long double> normal(randMean, randStdDev);
	...
	long double pass2Mean = 0.0, pass2Variance = 0.0;
	...
	pass2Mean = pass2Mean / static_cast<long double>(samples);
	...
	pass2Variance = pass2Variance / static_cast<long double>(samples - 1);
